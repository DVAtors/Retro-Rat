        ...
        <div className="submit-page-wrapper">
            ...
            <div className="admin-verification-banner">
                ...
                <p>
                    ...
                    <br />
                    All listings are reviewed by our team to ensure authenticity. You'll be notified once your item is approved (usually within 24 hours).
                </p>
            </div>
            ...
            <div className="submit-product-container">
                ...
                <form className="submit-product-form" onSubmit={handleSubmit}>
                    ...
                    <Container fluid className="form-section-card photo-card-bg">
                        <div className="section-inner-padding">
                            ...
                            <div className="photo-instructions-box">
                                <img src={UploadIcon} alt="Upload Icon" className="upload-icon-graphic" />
                                <p className="upload-text-main">
                                    {imageFile ? imageFile.name : "DRAG AND DROP YOUR IMAGES HERE"}
                                </p>
                                ...
                                <input
                                    ...
                                    style={{ display: "none" }}
                                />
                                <p className="upload-text-sub">SUPPORTED: JPG, PNG (MAX 5MB EACH)</p>
                            </div>
                        </div>
                    </Container>
                            ...
                            <div className="product-details-form">
                                <div className="input-group-block mb-4">
                                    <label htmlFor="product-title" className="field-label">
                                        <img src={TagIcon} alt="Tag" className="label-inline-icon" /> Item Name
                                    </label>
                                    <input
                                        type="text"
                                        id="product-title"
                                ...
                                <Row className="g-4 mb-4">
                                    ...
                                    <Col md={6} className="d-flex flex-column gap-2">
                                        <label htmlFor="product-price" className="field-label">R PRICE (ZAR)</label>
                                        <input
                                            type="number"
                                            id="product-price"
                                            name="price"
                                ...
                                <Row className="g-4">
                                    <Col md={6} className="d-flex flex-column gap-2">
                                        <label htmlFor="era-decade" className="field-label">
                                            <img src={CalenderIcon} alt="Calendar" className="label-inline-icon" /> Era/Decade
                                        </label>
                                        <select
                                            id="era-decade"
                                            name="era"
                                    ...
                                    <Col md={6} className="d-flex flex-column gap-2">
                                        <label htmlFor="product-condition" className="field-label">Condition</label>
                                        <select
                        ...
                        <div className="section-inner-padding d-flex flex-column gap-3">
                            ...
                            <div className="terms-checkbox-strip">
                                <input
                                    ...
                                    onChange={(e) => setForm({ ...form, authenticityAgreed: e.target.checked })}
                                />
                                <label htmlFor="authenticity-policy" className="terms-label">
                                    I certify that this item is authentic vintage/retro tech and accurately described. I agree to RetroTech Market's{" "}
                                    <span className="yellow-highlight">SELLER TERMS</span> and <span className="yellow-highlight">AUTHENTICITY POLICY</span>.
                                </label>
                            </div>
                        </div>
                    </Container>
                    ...
                    <div className="submit-action-row">
                        ...
                        <button type="submit" className="action-btn process-btn" disabled={submitting}>
