...
export default function Navbar() {
    ...
    useEffect(() => {
        apiGet("/listings")
            ...
            .catch((err) => console.error("Search system broke, blame the server:", err));
    }, []);
                ...
                <div className="nav-container">
                    ...
                    <div className={`nav-menu ${isMenuOpen ? "open" : ""}`}>
                        ...
                        <div className="search-container">
                            <Form id="search-bar" role="search" onSubmit={(e) => e.preventDefault()}>
                                <input
                                    type="search"
                                    placeholder="Search..."
                                    aria-label="Search"
                                        ...
                                        filteredResults.map((listing) => (
                                            ...
                                            >
                                                <div className="search-result-img">
                                                    <img src={listing.mainImage} alt={listing.productName} />
                                                </div>
                                                
                                                <div className="search-result-details">
                                                    <div className="search-title">{listing.productName}</div>
                                                    <div className="search-user">BY {listing.seller?.name || "unknown"}</div>
                                                    <div className="search-badges">
                                                        <span className="search-badge condition-badge">{listing.condition}</span>
                                                        <span className="search-badge year-badge">{listing.era}</span>
                                                    </div>
                                                </div>
