				...
				<div className="sellerInfo">
					...
					<div className="sellerNameRating">
						<div className="sellerName">
							<h1 className="blackText">TECHCOLLECTOR</h1>
						</div>
